...
def make_test_lines() -> List['TestLine']:
    ...
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|   [R--Y] r |', 10.0))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('| R          |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('<'))
    ...
    test_lines.append(TestOutputLine('| R          |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('F R R'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|   |R--R| r |', 10.0))
    test_lines.append(TestOutputLine('| R--Y       |', 10.0))
    test_lines.append(TestOutputLine('| R          |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    ...
    test_lines.append(TestOutputLine('|    Y       |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('F B Y'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|   [B--Y] r |', 10.0))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|    Y       |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('B'))
    test_lines.append(TestOutputLine('|   [Y]      |', 10.0))
    test_lines.append(TestOutputLine('|   [B]    r |', 10.0))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|    Y       |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
