...
def make_test_lines() -> List['TestLine']:
    ...
    test_lines.append(TestInputLine('F R Y'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    ...
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestOutputLine('LEVEL CLEARED', 10.0))
    test_lines.append(TestInputLine('F Y B'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|   [Y--B]   |', 10.0))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|    R--Y    |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine(''))
    ...
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestOutputLine('LEVEL CLEARED', 10.0))
    test_lines.append(TestInputLine('A'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    ...
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|       Y    |', 10.0))
    test_lines.append(TestOutputLine('|    r  B    |', 10.0))
    test_lines.append(TestOutputLine('|    R--Y    |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('V 1 1 r'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|    r  Y    |', 10.0))
    test_lines.append(TestOutputLine('|    r  B    |', 10.0))
    test_lines.append(TestOutputLine('|    R--Y    |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestInputLine('V 0 1 r'))
    ...
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestOutputLine('LEVEL CLEARED', 10.0))
    test_lines.append(TestInputLine('F Y Y'))
    test_lines.append(TestOutputLine('|            |', 10.0))
    test_lines.append(TestOutputLine('|   |Y--Y|   |', 10.0))
    test_lines.append(TestOutputLine('|       B    |', 10.0))
    test_lines.append(TestOutputLine('|       Y    |', 10.0))
    test_lines.append(TestOutputLine(' ------------ ', 10.0))
    test_lines.append(TestOutputLine('GAME OVER', 10.0))
